 ...
 */
final class Version20190820130005 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE responses ADD message VARCHAR(50) NOT NULL, CHANGE questions_id questions_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE responses DROP message, CHANGE questions_id questions_id INT NOT NULL');
    }
}
